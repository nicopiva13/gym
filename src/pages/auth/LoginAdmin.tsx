...
import { Dumbbell, Loader2, User, Lock, AlertCircle } from 'lucide-react';
...
export default function LoginAdmin() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-[#09090b] relative overflow-hidden">
            ...
            >
                <h1 className="text-5xl font-display font-black text-white tracking-[0.2em] mb-2">IRON<span className="text-amber-500">GYM</span></h1>
                <p className="text-[10px] font-body font-black text-neutral-500 uppercase tracking-[0.4em]">Administration Panel</p>
            </motion.div>
            ...
            >
                <div>
                    <h2 className="text-3xl font-display text-white uppercase tracking-wider">Bienvenido Owner</h2>
                    <p className="text-xs text-neutral-500 font-body uppercase tracking-widest font-bold">Acceso restringido a dueños</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-500 ml-1">Contraseña</label>
                        <div className="relative">
                    ...
                    <button 
                      ...
                      className="w-full text-center text-[9px] font-black text-neutral-600 hover:text-amber-500 uppercase tracking-widest transition-colors"
                    >
                        ¿No eres administrador? Volver
                    </button>
                </form>
            </motion.div>
        </div>
